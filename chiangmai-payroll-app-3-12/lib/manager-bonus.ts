...
export const MANAGER_BONUS_RUBRICS: Record<'Front' | 'Kitchen', ManagerBonusRubricItem[]> = {
  Front: [
    ...
    { id:'reporting_communication', label:'Reporting & Communication', description:'Daily logbooks, manager reports, Black Box/Blackfox review, shift communication, follow-up on action items.' },
  ...
  Kitchen: [
    ...
    { id:'reporting_communication', label:'Reporting & Communication', description:'Prep lists, waste logs, shift handoff notes, Black Box/Blackfox review, follow-up on action items.' },
