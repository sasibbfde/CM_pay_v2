...
export default function InsightsPage() {
  ...
  const downloadExcel = () => {
    window.location.href = `/api/insights/export?from=${fromDate}&to=${toDate}`;
  };
    ...
    <div style={{background:'#0a0c10',minHeight:'100vh',color:'#e5e7eb',fontFamily:'Inter,sans-serif',padding:'20px 28px'}}>
      ...
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:16,flexWrap:'wrap',gap:12}}>
        <div>
          ...
          <p style={{color:'#6b7280',fontSize:12,margin:'3px 0 0'}}>{fromDate} → {toDate} · {filteredRows.length} employees</p>
        </div>
