...
const defaults = {
  ...
  locations: ['Imm Thai Kitchen', 'Chiang Mai Junction', 'Chiang Mai Liberty Village', 'Chiang Mai Mississauga', 'Chiang Mai York Mills', 'Chiang Mai Parklawn', 'Chiang Mai Danforth', 'Office']
};
